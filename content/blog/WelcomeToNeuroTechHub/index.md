...
tags: ["community", "neurotech"]
categories: ["announcement"]
summary: "The story behind NeuroTechHub: from encountering the same challenges across neurotech teams, to being inspired by open-source projects like Open Ephys, to building a community where people can connect and share."
featured_image: "welcometoneurotechhub.jpg"
draft: False
---

# Welcome to NeuroTechHub

Around 2022, we were working in neurotechnology—specifically visual implants—across different academic and industrial teams. We met through [international research consortia](https://intenseproject.eu/) and quickly realized we were running into the same questions again and again: Which stimulation and recording systems actually exist? How should signal analysis be done properly? What does good grounding of your setup look like in practice?
...
There are, fortunately, inspiring exceptions. A shining example is [Open Ephys](https://open-ephys.org/), who are making open-source software and hardware. In adjacent fields, projects like Pupil Labs demonstrate a similar spirit by openly sharing both [hardware](https://docs.pupil-labs.com/core/diy/) and [software](https://docs.pupil-labs.com/core/developer/) for eye tracking.

Inspired by these efforts, we started experimenting with ways to bring people together. We [organized](https://neurotechhub.org/events/) talks, meetups, workshops and a an [Awesome Open Neurotech page](https://neurotechhub.org/blog/awesomeopenneurotech/) which turned out to be deeply motivating experiences. Industry experts were eager to give talks, graduates to explain their theses, and students to participate in workshops. Again and again, we saw that people genuinely want to share their knowledge and are willing to put in extra effort so others can build on their work.
